...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `loanagent-lab` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in loanagent-lab.
